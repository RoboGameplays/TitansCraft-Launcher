...
public class Launcher {
    ...
    public Launcher() {
        ...
        mirrorStore.addSecureMirror("titanscraft.net/storage/modpack", new JsonWebSecureMirror("http://titanscraft.net/storage/modpack/", "titanscraft.net/storage/modpack"));
        ...
        DonorSite donors = new DonorSite("http://www.titanscraft.net/doar");
